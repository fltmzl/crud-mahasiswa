...
<html lang="en">
  ...
  <body>
    <div class="flex w-full h-screen">
      <!-- Navigation -->
      <nav class="py-5 w-44 border-r h-screen overflow-y-auto hidden md:block">
        <!-- Nav Brand -->
      ...
      <!-- Navigation -->
      <nav class="fixed bottom-0 z-50 bg-white custom-shadow-sm w-screen h-16 flex justify-evenly md:hidden">
          <a href="<?= APP_URL ?>/" class="px-5 py-2 flex items-center space-x-3" data-navbar="dashboard">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <a href="<?= APP_URL ?>/database" class="px-5 py-2 flex items-center space-x-3" data-navbar="database">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path stroke-linecap="round" stroke-linejoin="round" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
            </svg>
          </a>
          <a href="<?= APP_URL ?>/attendance" class="px-5 py-2 flex items-center space-x-3" data-navbar="attendance">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <a href="<?= APP_URL ?>/logout" class="px-5 py-2 flex items-center space-x-3">
