...
<div class="flex-1 px-6 py-5 h-screen overflow-auto">
    <!-- Main Section Header -->
    ...
    <div class="mt-8 mb-4 flex justify-between">
        <h2>Attendance</h2>
        <button id="btnAddAttendance" class="btn btn-primary text-sm">
    ...
    <div id="chartContainer" class="w-full space-y-10">
        ...
        <div class="p-5 custom-shadow-sm bg-white rounded-lg space-y-5">
            <h4>Dosen</h4>
            <canvas id="dosenChart" width="400" height="150"></canvas>
        </div>
    </div>
</div>
