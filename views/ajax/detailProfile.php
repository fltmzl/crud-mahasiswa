...
<div class="space-y-10 self-start mt-5">
    <section class="w-full text-center space-y-3 relative">
        ...
        <div class="right-2 absolute flex flex-col space-y-3">
            ...
            <!-- Delete Button -->
            <a id="btnDelete" href="<?= APP_URL ?>/database/destroy/<?= $data["table"] ?>/<?= $data["id"] ?>" class="p-2 rounded-lg bg-gray-200 hover:text-red-600 hover:bg-red-50 text-sm duration-300 ease-out" title="Delete">
        ...
        <!-- Profile Picture -->
        <div class="w-20 aspect-square rounded-full bg-green-100 mx-auto">
            <img src="" alt="" />
        </div>
